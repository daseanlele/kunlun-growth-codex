...
export const providerPresets: ProviderPreset[] = [
  ...
  { id: "groq", name: "Groq", region: "全球", kind: "api", protocol: "openai-compatible", adapter: "openai-chat", baseUrl: "https://api.groq.com/openai/v1", suggestedModels: ["openai/gpt-oss-120b", "qwen/qwen3.6-27b"], note: "低延迟 OpenAI 兼容接口" },
